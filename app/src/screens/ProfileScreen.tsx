    ...
    <>
      ...
      <TouchableOpacity
        style={[
          styles.button,
          isAmplo && styles.buttonAmplo,
          { backgroundColor: 'transparent', borderWidth: 2, borderColor: '#ef4444', marginTop: 16 },
          isAltoContraste && { borderColor: '#000000', borderWidth: 4 }
        ]}
      ...
      >
        <Text style={[
          styles.buttonText,
          { color: '#ef4444' },
          isAltoContraste && { color: '#000000', fontWeight: '900' }
        ]}>
          Sair da conta
        </Text>
      </TouchableOpacity>
